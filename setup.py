...
setup(
    ...
    description='cbrain API wrapper using tapioca',
    long_description=readme,
    author=get_author(package),
    author_email=get_email(package),
    url='https://github.com/martelogan/tapioca-cbrain',
    packages=[
        'tapioca_cbrain',
    ],
    package_dir={'tapioca_cbrain': 'tapioca_cbrain'},
